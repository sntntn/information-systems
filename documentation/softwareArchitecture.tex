...
\title{Arhitekture sistema}

\begin{document}
\maketitle

\section{Koriscena Arhitektura Sistema}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.5\linewidth]{softwareArchitectureDiagram.png}
